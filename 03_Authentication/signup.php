...
<body id="swup" class="transition-fade auth-page">
    ...
    <div class="container-fluid vh-100 p-0">
        <div class="row h-100 g-0">
            ...
            <!-- right panel-->
            <div
                class="col-lg-6 col-md-6 right-panel-container d-flex flex-column align-items-center justify-content-center">
                <div class="card-signup">
                    <div class="card-body">
                        ...
                        <form id="signupForm" action="../02_Actions/01_Authentication-CRUD/signup-validate.php"
                                ...
                                <div class="row g-2 mb-3">
                                    <div class="col-6 col-lg-12">
                                        <input type="text" name="Fname" id="Fname" class="form-control form-signup"
                                            placeholder="First Name" value="<?= htmlspecialchars($fd['Fname'] ?? '') ?>"
                                            required>
                                    </div>
                                    <div class="col-6 col-lg-12">
                                    ...
                                    <div class="col-6 col-lg-12">
                                        <input type="text" name="Lname" id="Lname" class="form-control form-signup"
                                            placeholder="Last Name" value="<?= htmlspecialchars($fd['Lname'] ?? '') ?>"
                                            required>
                                    </div>
                                    <div class="col-6 col-lg-12">
                                ...
                                <div class="row g-2 mb-3">
                                    <div class="col-6">
                                        <select name="gender" id="gender" class="form-select form-signup" required>
                                            <option value="" disabled <?= empty($fd['gender']) ? 'selected' : '' ?>>
                                                Gender</option>
                                            <option value="Male" <?= ($fd['gender'] ?? '') === 'Male' ? 'selected' : '' ?>>
                                                Male</option>
                                    ...
                                    <div class="col-6">
                                        <input type="date" name="birth_date" id="birth_date"
                                            ...
                                            value="<?= htmlspecialchars($fd['birth_date'] ?? '') ?>" required>
                                    </div>
                                </div>
                            ...
                            <div class="form-step" id="step2" style="display: none;">
                                ...
                                <div class="row g-2 mb-3">
                                    <div class="col-12">
                                        <select name="Province" id="Province_ID" class="form-select form-signup"
                                            required>
                                    ...
                                    <div class="col-12">
                                        <select name="Barangay" id="Barangay_ID" class="form-select form-signup"
                                            required>
                                    ...
                                    <div class="col-12">
                                        <input type="text" name="Street" id="Street" class="form-control form-signup"
                                            ...
                                            value="<?= htmlspecialchars($fd['Street'] ?? '') ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="row g-2 mb-3">
                                    ...
                                    <div class="col-12">
                                        <input type="text" name="username" id="username"
                                            class="form-control form-signup" placeholder="Username"
                                            value="<?= htmlspecialchars($fd['username'] ?? '') ?>" required>
                                    </div>
                                    <div class="col-12">
                                        <!-- Passwords are intentionally NOT restored for security -->
                                        <input type="password" name="password" id="password"
                                            class="form-control form-signup" placeholder="Password"
                                            <?= htmlspecialchars($fd['password_hash'] ?? '') ?> required>
                                    </div>
                                    <div class="col-12">
                                        <input type="password" name="confirmpass" id="confirmpass"
                                            class="form-control form-signup" placeholder="Confirm Password" required>
                                    </div>
                                </div>
                            ...
                            <p class="report-text text-center">Already have an account? <a
                                    href="../03_Authentication/login.php" class="signup-link">Login</a></p>
                        </form>
                    </div>
                </div>
            </div>
